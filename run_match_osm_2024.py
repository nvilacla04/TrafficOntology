"""
Script to match BRON accident data for 2024 to OSM road segments.

This script reads a cleaned BRON accidents CSV for the year 2024, converts it
...
def main() -> None:
    # -------------------------------------------------------------------------
    # Step 1: Load the BRON accident data for 2024
    # -------------------------------------------------------------------------
    ...
    print(f"Loaded {len(df_bron)} accidents with valid locations and street names from 2024.")
